...
public interface StudentImplService extends IService<Student> {
    ...
    CommonResult studentPaper(int paperid,String stuid);

    CommonResult showStudentPaper(int paperid,String stuid);

    CommonResult correctPaper(Map map);

    CommonResult studentStudent(int paperid);
